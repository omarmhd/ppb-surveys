    ...
    <div class="container-fluid d-flex align-items-stretch justify-content-between">
        ...
        <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
            <a href="index.html" class="d-lg-none">
                <img alt="Logo" src="https://ppb.ps/assets/site/images/logo.png" class="h-30px" />
            </a>
        </div>
        <!--end::Mobile logo-->
        <!--begin::Wrapper-->
...
{{--                                            <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">--}}
{{--                                                <div class="menu-item">--}}
{{--                                                    <a class="menu-link active py-3" href="pages/blog/home.html">--}}
{{--																			<span class="menu-bullet">--}}
{{--																				<span class="bullet bullet-dot"></span>--}}
{{--																			</span>--}}
...
{{--                                                    <img src="https://cdn2.iconfinder.com/data/icons/flat-style-svg-icons-part-1/512/man_user_male_human_people-512.png" alt="" />--}}
{{--                                                </div>--}}
{{--                                                <!--end::Symbol-->--}}
{{--                                                <!--begin::Title-->--}}
...
{{--                    </div>--}}
                    ...
                    <div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                        ...
                        <div class="cursor-pointer symbol symbol-30px symbol-md-40px" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end" data-kt-menu-flip="bottom">
                            <img src="https://cdn2.iconfinder.com/data/icons/flat-style-svg-icons-part-1/512/man_user_male_human_people-512.png" alt="metronic" />
                        </div>
                        <!--begin::Menu-->
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold py-4 fs-6 w-275px" data-kt-menu="true">
                            ...
                            <div class="menu-item px-3">
                                <div class="menu-content d-flex align-items-center px-3">
                                    ...
                                    <div class="symbol symbol-50px me-5">
                                        <img alt="Logo" src="https://cdn2.iconfinder.com/data/icons/flat-style-svg-icons-part-1/512/man_user_male_human_people-512.png" />
                                    </div>
                                    <!--end::Avatar-->
                                    <!--begin::Username-->
                                    <div class="d-flex flex-column">
                            ...
                            <div class="menu-item px-5">
                                <a href="{{route('showMyEvaluation')}}" class="menu-link px-5">تقيماتي</a>
                            </div>
                            <!--end::Menu item-->
                            <!--begin::Menu item-->
