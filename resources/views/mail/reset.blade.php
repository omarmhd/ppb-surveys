        ...
        <td>
            ...
            <table align="center" border="0" cellpadding="0" cellspacing="0" class="row row-2" role="presentation"
                ...
                <tr>
                    <td>
                        <table align="center" border="0" cellpadding="0" cellspacing="0" class="row-content stack"
                               role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;" width="640">
                            <tbody>
                            <tr>
                                <th class="column"
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" class="image_block"
                                        ...
                                        <tr>
                                            <td style="width:100%;padding-right:0px;padding-left:0px;">
                                                <div align="center" style="line-height:10px"><a href="www.example.com"
                                                                                                style="outline:none"
                                                                                                tabindex="-1"
                                                                                                target="_blank"><img
                                                            alt="Your logo."
                                                            src="{{asset('')}}/images/5f4fa970-2c78-4218-9e89-9953d812ddb4.png"
                                        ...
                                        <tr>
                                            <td style="width:100%;padding-right:0px;padding-left:0px;">
                                                <div align="center" style="line-height:10px"><a href="www.example.com"
                                                            ...
                                                            src="{{asset('')}}/images/___passwordreset.gif"
                                                ...
                                                <div style="font-family: Arial, sans-serif">
                                                    <div
                                                        ...
                                                        <p style="margin: 0; font-size: 16px; text-align: center;"><span
                                                                style="font-size:30px;color:#2b303a;"><strong>Forgot Your Password?</strong></span>
                                                        </p>
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td style="padding-left:10px;padding-right:10px;padding-top:15px;text-align:center;">
                                                <div align="center">
                                                    ...
                                                    <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml"
                                                                 ...
                                                                 style="height:62px;width:210px;v-text-anchor:middle;"
                                                                 arcsize="57%" stroke="false" fillcolor="#f7a50c">
                                                        <w:anchorlock/>
                                                    ...
                                                    <![endif]--><a href="www.example.com"
                                                            ...
                                                            style="padding-left:30px;padding-right:30px;font-size:16px;display:inline-block;letter-spacing:normal;"><span
                                                                style="font-size: 16px; margin: 0; line-height: 2; word-break: break-word; mso-line-height-alt: 32px;"><strong>RESET PASSWORD</strong></span></span></a>
                                        ...
                                        <tr>
                                            <td style="width:100%;padding-right:0px;padding-left:0px;">
                                                <div align="center" style="line-height:10px"><a href="www.example.com"
                                                                                                ...
                                                                                                target="_blank"><img
                                                            alt="Your logo. "
                                                            src="{{asset('')}}/images/aa73bcbb-1ce0-453a-8b6f-4f9e10336b9c.png"
