    ...
    <div class="card">
        ...
        <div class="card-body py-1">
            ...
            <div class="mb-13 mt-5 text-start">
                <!--begin::Title-->
                <h1 class="mb-3">قسم  {{$section->title}} </h1>
                <!--end::Title-->
                <!--begin::Description-->
...
{{--                                    <label>السؤال:</label>--}}
                                ...
                                <div class="col-md-2">
                                        ...
                                        <label class="form-check form-check-inline form-check-solid is-invalid">
                                            ...
                                            <span class="fw-bold ps-2 fs-6">تفعيل</span>
                                        </label>
...
{{--                                        <label>السؤال:</label>--}}
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <label class="form-check form-check-inline form-check-solid is-invalid">
                                            <input class="form-check-input" name="active[]" disabled type="checkbox" value="1">
                                            <span class="fw-bold ps-2 fs-6">تفعيل</span>
                                        </label>
...
@endsection
@push('js')
    @include("parts.sweetCreate", ['route' => route('question.store',$section->id )])
