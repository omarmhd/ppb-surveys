                        ...
                        <div class="row mb-2">
                            ...
                            <div data-repeater-list="" class="col-lg-10">
                                <div data-repeater-item="" class="form-group row align-items-center">
                                    ...
                                    <div class="col-md-6">
                                        {{--                                    <label>السؤال:</label>--}}
                                        <input type="text" class="form-control form-control-solid" placeholder="" value="{{$question->name}}" name="question[]">
...
@endsection
@push('js')
    @include("parts.sweetCreate", ['route' => route('sections.update',['section' => $section]),'method'=>'put'])
